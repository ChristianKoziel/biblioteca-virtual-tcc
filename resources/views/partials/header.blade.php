        ...
        <div class="flex items-center space-x-2 md:hidden">
            ...
            @auth
                <button id="mobile-avatar-btn" class="flex items-center focus:outline-none">
                    <img src="{{ Auth::user()->avatar ? 'storage/'.Auth::user()->avatar : '/usuario.png' }}" alt="Usuário" class="h-8 w-8 rounded-full border-2 border-indigo-200 hover:border-indigo-400 shadow-md transition-all duration-200">
                </button>
            @else
                <button id="mobile-avatar-btn" class="flex items-center focus:outline-none">
                    <img src="/usuario.png" alt="Usuário" class="h-8 w-8 rounded-full border-2 border-indigo-200 hover:border-indigo-400 shadow-md transition-all duration-200">
                </button>
            @endauth
        </div>
            ...
            @auth
                ...
                <div class="flex items-center">
                    <button id="avatar-btn" class="flex items-center focus:outline-none" aria-expanded="false">
                        <img src="{{ Auth::user()->avatar ? 'storage/'.Auth::user()->avatar : '/usuario.png' }}" alt="Usuário" class="h-10 w-10 rounded-full border-2 border-indigo-200 hover:border-indigo-400 shadow-md transition-all duration-200">
    ...
    <div id="mobile-user-menu" class="hidden md:hidden px-4 py-3 bg-white border-t border-gray-200">
        @auth
            <div class="flex items-center mb-4 pb-2 border-b border-gray-200">
                <img src="{{ Auth::user()->avatar ? 'storage/'.Auth::user()->avatar : '/usuario.png' }}" alt="Usuário" class="h-10 w-10 rounded-full border-2 border-indigo-200 mr-3">
                <div>
